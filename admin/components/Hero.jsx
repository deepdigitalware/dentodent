...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32">
      ...
      >
        <img src={smileIcon} alt="Decorative" className="w-16 h-16" />
      </motion.div>
      <motion.div
        aria-hidden="true"
        initial={{ opacity: 0, y: 10 }}
      ...
      >
        <img src={smileIcon} alt="Decorative" className="w-12 h-12" />
      </motion.div>
      <motion.div
        aria-hidden="true"
      ...
      >
        <img src={smileIcon} alt="Decorative" className="w-20 h-20" />
      </motion.div>
          ...
          >
            ...
            >
              <Button
                ...
                className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 pulse-glow"
              >
            ...
            <motion.div
              ...
              className="grid grid-cols-4 lg:grid-cols-4 gap-2 md:gap-6"
            >
              {content.hero.stats.map((stat, index) => (
                <div key={index} className="text-center">
                  {React.createElement(getIconComponent(stat.icon), { className: "w-6 h-6 md:w-8 md:h-8 text-blue-600 mx-auto mb-1 md:mb-2" })}
          ...
          >
            {!splineUrl && (
              <div className="relative z-10">
                <img 
                  className="w-full h-auto rounded-3xl shadow-2xl card-3d"
