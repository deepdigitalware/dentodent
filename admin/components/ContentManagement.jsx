...
import { Save, Edit3, Eye, Upload, X, Plus } from 'lucide-react';
...
const ContentManagement = () => {
  ...
  const tabs = [
    ...
    { id: 'slider', label: 'Slider Banner', icon: '🖼️' },
  ...
  const handleSave = async () => {
    try {
      const result = await updateContent(activeTab, editingContent);
      if (result?.success) {
        // Update localContent to reflect the saved changes
        ...
        const message = result?.error || 'Failed to save content. Please log in and try again.';
        toast.error(message);
      }
    } catch (error) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            disabled={!isEditing}
            placeholder="16x16 or 32x32 icon URL"
          />
        </div>
      </div>
          ...
          <div key={index} className="p-4 border border-gray-200 rounded-lg mb-4">
            ...
            <div className="mb-3">
              ...
              <input
                type="text"
                value={post.cover || ''}
                onChange={(e) => handleArrayChange('blogPosts', index, 'cover', e.target.value)}
                className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                disabled={!isEditing}
              />
            </div>
  ...
  const renderSliderEditor = () => (
    <div className="space-y-6">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <label className="block text-sm font-medium text-gray-700">Slider Items</label>
          {isEditing && (
            <Button
        ...
        {editingContent.items?.map((slide, index) => (
          <div key={index} className="p-4 border border-gray-200 rounded-lg mb-3">
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="flex space-x-2">
                <label className="inline-flex items-center">
                  <input
                    ...
                    onChange={(e) => handleArrayChange('items', index, 'active', e.target.checked)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
              ...
              <div>
                ...
                <input
                  type="number"
                  value={slide.order || 0}
                  onChange={(e) => handleArrayChange('items', index, 'order', parseInt(e.target.value) || 0)}
                  className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  disabled={!isEditing}
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  type="text"
                  value={slide.linkUrl || ''}
                  onChange={(e) => handleArrayChange('items', index, 'linkUrl', e.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleArrayChange('items', index, 'linkLabel', e.target.value)}
        ...
        {isEditing && editingContent.items && editingContent.items.length === 0 && (
          <p className="text-gray-500 text-sm">No slides added yet. Add slides to display in the slider.</p>
        )}
        
        {/* Legacy images support for backward compatibility */}
        <div className="mt-6 pt-4 border-t border-gray-200">
          <div className="flex justify-between items-center mb-4">
            <label className="block text-sm font-medium text-gray-700">Legacy Images (backward compatibility)</label>
            {isEditing && (
              <Button
          ...
          {editingContent.images?.map((image, index) => (
            <div key={index} className="flex mb-3">
              <input
                type="text"
                value={image || ''}
                onChange={(e) => handleArrayChange('images', index, index, e.target.value)}
                placeholder="Enter image URL"
                className="flex-1 p-2 border border-gray-300 rounded-l focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                disabled={!isEditing}
              />
  ...
  const renderTreatmentsEditor = () => (
    <div className="space-y-6">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <label className="block text-sm font-medium text-gray-700">Treatment Items</label>
          {isEditing && (
            <Button
              onClick={() => addArrayItem('items', { 
                title: '', 
          ...
          <div key={index} className="p-4 border border-gray-200 rounded-lg mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <input
                ...
                placeholder="Slug"
                value={item.slug || ''}
                onChange={(e) => handleArrayChange('items', index, 'slug', e.target.value)}
                className="p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                disabled={!isEditing}
              />
              <textarea
                ...
                className="p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent md:col-span-2"
                rows="2"
                disabled={!isEditing}
              />
              <input
                ...
                value={item.imageUrl || ''}
                onChange={(e) => handleArrayChange('items', index, 'imageUrl', e.target.value)}
                className="p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent md:col-span-2"
                disabled={!isEditing}
              />
            </div>
  ...
  const renderReviewsEditor = () => (
    <div className="space-y-6">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <label className="block text-sm font-medium text-gray-700">Review Items</label>
          {isEditing && (
            <Button
              onClick={() => addArrayItem('items', { 
                name: '', 
          ...
          <div key={index} className="p-4 border border-gray-200 rounded-lg mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <textarea
                ...
                value={item.message || ''}
                onChange={(e) => handleArrayChange('items', index, 'message', e.target.value)}
                className="p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent md:col-span-2"
                rows="3"
                disabled={!isEditing}
              />
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            type="text"
            value={editingContent.longitude || ''}
