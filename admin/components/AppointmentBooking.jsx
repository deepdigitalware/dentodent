...
const AppointmentBooking = () => {
  ...
  const urgencyLevels = [
    ...
    { id: 'emergency', label: 'Emergency', description: 'Severe pain or trauma', color: 'red' }
  ];
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                className="bg-white text-blue-700 hover:bg-blue-50 px-4 py-2 rounded-full font-medium"
              >
                Chat on WhatsApp
              </Button>
            </div>
